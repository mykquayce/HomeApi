...
RUN dotnet publish HomeApi.WebApplication/HomeApi.WebApplication.csproj --configuration Release --output /app/publish
...
ENTRYPOINT ["dotnet", "HomeApi.WebApplication.dll"]
